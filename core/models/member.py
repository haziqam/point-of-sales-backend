...
class VIPMember(Member):
    ...
    @classmethod
    def upgrade_from_member(cls, member: Member, 
            discount_rate: float = DEFAULT_DISCOUNT_RATE) -> "VIPMember":
        return cls(public_data=member.public_data, email=member.email, 
                   hashed_PIN=member.hashed_PIN, discount_rate=discount_rate)
