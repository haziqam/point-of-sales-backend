...
class IProductRepository(ABC):
    @abstractmethod
    def create_product(self, name: str, description: str, price: float, stock: int, **kwargs) -> Product:
        pass
    ...
    def find_products(self, page: int = 1, number_per_page: int = 10, *, 
                      ...
                      price: Optional[float] = None, stock: Optional[int] = None, **kwargs) -> List[Product]:
        pass
